...
class WorldState(object):
  ...
  def cook(self, ingredient, tool, out, outdesc, manner):
    ...
    i = self.I_d[ingredient]
    if self.__IsNull(tool):
      return self.__RemoveIngredient(ingredient).__AddIngredient(out, 'cooked '+i).__UpdateContain(ingredient, out)
    else:
      return self.__RemoveIngredient(ingredient).__AddIngredient(out, 'cooked '+i).__AddContain(out, tool).__UpdateContain(ingredient, out)
